...
output_dir = os.path.join(base_dir, 'model_files', 'malta_simulation')
model_name = 'Malta_Model'
model_dir = os.path.join(output_dir, model_name)

# Paths to model executables
imod_exe = os.path.join(base_dir, 'model_files', 'bin', 'imodwq', 'imod-wq_svn392_x64r.exe')
seawat_dir = os.path.join(base_dir, 'model_files', 'bin', 'SEAWAT', 'swt_v4_00_05')
...
with open('runmod_parallel_working.bat', 'w') as infile:
    infile.write("\"{}\" \"{}\{}.nam_swt\"".format(imod_exe,mini_sp_dir,mini_modelname))
infile.close()
